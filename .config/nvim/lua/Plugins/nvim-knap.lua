...
local gknapsettings = {
	texoutputext = "pdf",
	textopdf = "latexmk -pdf -halt-on-error %docroot% && latexmk -c",
	textopdfviewerlaunch = "zathura %outputfile%",
	textopdfviewerrefresh = "none",
	mdoutputext = "pdf",
	mdtopdf = "pandoc -V colorlinks=false -V linkcolor=black -V urlcolor=black -V toccolor=black %docroot% -o %outputfile%",
