...
hi CursorLine       guisp=NONE      guifg=NONE      guibg=#313354   ctermfg=NONE    ctermbg=236  gui=NONE           cterm=NONE
hi Directory        guisp=NONE      guifg=#de4b3b   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
...
hi DiffText         guisp=NONE      guifg=#1E1E2E   guibg=#de4b3b   ctermfg=235     ctermbg=117  gui=NONE           cterm=NONE
...
hi Folded           guisp=NONE      guifg=#de4b3b   guibg=#45475A   ctermfg=117     ctermbg=240  gui=NONE           cterm=NONE
...
hi MoreMsg          guisp=NONE      guifg=#de4b3b   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
...
hi Question         guisp=NONE      guifg=#de4b3b   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
...
hi SpellLocal       guisp=#de4b3b   guifg=NONE      guibg=NONE      ctermfg=117     ctermbg=NONE gui=underline      cterm=underline
hi SpellRare        guisp=#A6E3A1   guifg=NONE      guibg=NONE      ctermfg=151     ctermbg=NONE gui=underline      cterm=underline
hi StatusLine       guisp=NONE      guifg=#FFFFFF   guibg=#de4b3b ctermfg=254     ctermbg=234  gui=NONE           cterm=NONE
...
hi TabLineFill      guisp=NONE      guifg=NONE      guibg=#de4b3b   ctermfg=NONE    ctermbg=234  gui=NONE           cterm=NONE
hi TabLineSel       guisp=NONE      guifg=#A6E3A1   guibg=#45475A   ctermfg=151     ctermbg=240  gui=NONE           cterm=NONE
hi Title            guisp=NONE      guifg=#de4b3b   guibg=NONE      ctermfg=117     ctermbg=NONE gui=bold           cterm=bold
...
hi Comment          guisp=NONE      guifg=#74aaf3   guibg=NONE      ctermfg=243     ctermbg=NONE gui=NONE           cterm=NONE
...
hi Type             guisp=NONE      guifg=#de4b3b   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
...
hi Function         guisp=NONE      guifg=#de4b3b   guibg=NONE      ctermfg=117     ctermbg=NONE gui=NONE           cterm=NONE
